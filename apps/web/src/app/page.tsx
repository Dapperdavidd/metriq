...
//
// The composition root. This is the ONE place that chooses the transport. Everything
// below reads the same RunState from the same reducer, so flipping the source is a
// transport change with zero component change.
//
